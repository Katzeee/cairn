...
export const fieldValueSuggestionIds = {
  ...
  "options-from-supertag": ["kei", "cairn-team"],
} as const;
...
const initialSeeds: readonly Seed[] = [
  seed("projects", { content: textContent("Projects") }, [
    seed("cairn", { content: [...textContent("Cairn "), demoInlineToken("supertag", "supertag-project", "project")] }, [
      ...
      field("owner-field", "owner-definition", "Owner", [
        ...
        fieldValue("team-owner", "Cairn team", { targetNodeId: "cairn-team" }),
      ]),
  ...
  seed("archive", { content: textContent("Archive") }, [
    seed("value-library", { content: textContent("Value library") }, [
      ...
      seed("cairn-team-original", { content: textContent("Cairn team") }, undefined, { nodeId: "cairn-team" }),
    ]),
