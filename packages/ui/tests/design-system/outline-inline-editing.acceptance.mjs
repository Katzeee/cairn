...
designSystemTest("outline source editing keeps single-line rows and following bullets stable", async (page) => {
  ...
  for (const font of ["inherit", "Arial, sans-serif", '"Segoe UI", sans-serif']) {
    await tree.evaluate((element, family) => {
      element.style.fontFamily = family;
    }, font);
    for (const path of ["projects/cairn/roadmap/command-palette", "projects/cairn"]) {
