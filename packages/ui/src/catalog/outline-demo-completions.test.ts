...
import { contentToSource, type OutlineContent } from "../components/node-editor/outline-content.js";
...
describe("host-owned inline completions", () => {
  it("excludes unnamed nodes and commands in the external providers", () => {
    ...
    for (const id of ["kei", "cairn-team", "status-definition", "supertag-person"]) {
